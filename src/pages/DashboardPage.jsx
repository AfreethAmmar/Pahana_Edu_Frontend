            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <button className="relative group bg-gray-50 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 rounded-lg hover:bg-gray-100">
                <div className="flex flex-col items-center">
                  <span className="rounded-lg inline-flex p-3 bg-blue-50 text-blue-700 ring-4 ring-white group-hover:bg-blue-100">
                  ...
                  <div className="mt-4 text-center">
                    ...
                    <p className="text-sm text-gray-500">Add new books or stationary</p>
                  </div>
                </div>
              </button>

              <button className="relative group bg-gray-50 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-emerald-500 rounded-lg hover:bg-gray-100">
                <div className="flex flex-col items-center">
                  <span className="rounded-lg inline-flex p-3 bg-emerald-50 text-emerald-700 ring-4 ring-white group-hover:bg-emerald-100">
                    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button className="relative group bg-gray-50 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-amber-500 rounded-lg hover:bg-gray-100">
                <div className="flex flex-col items-center">
                  <span className="rounded-lg inline-flex p-3 bg-amber-50 text-amber-700 ring-4 ring-white group-hover:bg-amber-100">
                    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
                    </svg>
                  </span>
                  <div className="mt-4 text-center">
                    <h3 className="text-sm font-medium text-gray-900">Stock Alert</h3>
                    <p className="text-sm text-gray-500">View low stock items</p>
                  </div>
                </div>
              </button>

              <button className="relative group bg-gray-50 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-purple-500 rounded-lg hover:bg-gray-100">
                <div className="flex flex-col items-center">
                      ...
                      <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-500">
                            Added new book <span className="font-medium text-gray-900">"Advanced Programming Concepts"</span>
                          </p>
                        </div>
                  ...
                  <div className="relative pb-8">
                    ...
                    <div className="relative flex space-x-3">
                      ...
                      <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-500">
                            Updated stock for <span className="font-medium text-gray-900">"Notebook A4"</span>
                          </p>
                        </div>
                        <div className="text-right text-sm whitespace-nowrap text-gray-500">
                  ...
                  <div className="relative">
                    <div className="relative flex space-x-3">
                      ...
                      <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-500">
                            New customer registered: <span className="font-medium text-gray-900">John Smith</span>
                          </p>
                        </div>
                        <div className="text-right text-sm whitespace-nowrap text-gray-500">
                          <time>1 day ago</time>
